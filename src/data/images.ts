  ...
  pools: {
    ...
    default: [
      ...
      [
        'player-bullet',
        'shmup/p-bullet.png',
        { totalFrame: 10, interval: 50, animated: true, loop: false },
      ],
      ...
      [
        'reactor',
        'shmup/reactor.png',
        { totalFrame: 4, interval: 40, animated: true },
      ],
      'shmup/ship.json',
      ...
      [
        'bg',
        'env/bg.jpg',
        { totalFrame: 1, animated: false, isReversed: false },
      ],
      [
        'canyon',
        'env/canyon.png',
      ...
      [
        'touchControlBackground',
        'touch-control/background.png',
        { totalFrame: 1, animated: false },
      ],
      [
        'touchControlStick',
        'touch-control/stick.png',
        { totalFrame: 1, animated: false },
      ],
